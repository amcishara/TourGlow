...
<body>
        ...
        <div class="row gx-0">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <small class="me-3 text-light"><i class="fa fa-map-marker-alt me-2"></i>223 Main Street, Colombo 7 ,
                        Sri Lanka</small>
                    ...
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        ...
                        <div class="position-relative w-75 mx-auto animated slideInDown">
                            <input class="form-control border-0 rounded-pill w-100 py-3 ps-4 pe-5" type="text"
                                placeholder="Eg: Ella">
                            <button type="button"
                                class="btn btn-info rounded-pill py-2 px-4 position-absolute top-0 end-0 me-2"
    ...
    <div class="post container">
        ...
        <div class="modal fade" id="sigiriyaModal" tabindex="-1" aria-labelledby="sigiriyaModalLabel"
            aria-hidden="true">
...
<div class="modal-body">
    <!-- Content of sigiriya.php goes here -->
    <!-- Example: -->
    ...
    <div class="input-group mt-3">
        ...
        <button class="btn btn-outline-secondary mb-5" type="button" id="commentButton">Comment</button>
    </div>
    
    <!-- Display comments -->
    <ul id="commentList"></ul>
    <!-- Like button -->
    <button type="button" class="btn btn-primary mt-3" id="likeButton"><i class="far fa-thumbs-up"></i> Like <span id="likeCount">0</span></button>
    <span id="commentCount" class="mt-2">0 Comments</span>
        ...
        <!-- Post box -->
        <div class="post-box tech" data-bs-toggle="modal" data-bs-target="#sigiriyaModal">
            ...
            <p class="post-description">Sigiriya, also known as Lion Rock, is a UNESCO World Heritage Site and one of
                Sri Lanka's most awe-inspiring destinations. This ancient rock fortress, dramatically rising from the
                surrounding plains, holds a captivating blend of history, engineering marvels, and natural beauty.</p>
            <div class="profile">
        ...
        <div class="post-box ">
            ...
            <h2 class="text-info category mt-3 ">Tech</h2>
        ...
        <div class="post-box food">
            ...
            <h2 class="text-info category mt-3 ">Food</h2>
            <a href="#" class="post-title">How to create the best UI with Figma</a>
            <span class="post-date">12 Feb 2022</span>
            <p class="post-description">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consectetur,
                similique, rerum excepturi harum, vitae facilis corrupti vel modi debitis est perferendis aut quasi ea
        ...
        <div class="post-box news">
            <img src="images/img4.jpg" alt="" class="post-img">
            <h2 class="text-info category mt-3 ">News</h2>
            <a href="#" class="post-title">How to create the best UI with Figma</a>
            <span class="post-date">12 Feb 2022</span>
            <p class="post-description">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consectetur,
                similique, rerum excepturi harum, vitae facilis corrupti vel modi debitis est perferendis aut quasi ea
