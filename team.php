    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-info px-3">Travel Guide</h6>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                    <a href="#" class="service-item rounded pt-3 text-decoration-none" data-toggle="modal" data-target="#exampleModal" style="background-color: #ffffff !important; display: block;">
                        <div class="p-4">
                            <i class="fa fa-3x fa-plus-circle text-info mb-4"></i>
                            <h5>Add New</h5>
                            <p>Click to add something new</p>
                        </div>
                    </a>
