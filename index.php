...
<body>
                ...
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <!-- <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="/user-profile/profile.php" class="dropdown-item">User Profiles</a>
                            <a href="Niches.php" class="dropdown-item">Niches</a>
                            <a href="../RealEstate-PHP (1)/RealEstate-PHP/index.php" class="dropdown-item">demo</a>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                    <a href="destination.php" class="service-item rounded pt-3 text-decoration-none"
                        data-toggle="modal" data-target="#exampleModal"
                        style="background-color: #ffffff !important; display: block;">
                        <div class="p-4">
                            <i class="fa fa-3x fa-hotel text-info m-0 mb-4"></i>
                            <h5>Destination Guides</h5>
                            <p style="color: #0d6efd;">Explore our guides for insights into Sri Lanka's top spots. From culture to local tips, TourGlow helps you discover this paradise</p>
                        </div>
                    </a>
                </div>
    
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                    <a href="Niches.php" class="service-item rounded pt-3 text-decoration-none"
                        data-toggle="modal" data-target="#exampleModal"
                        style="background-color: #ffffff !important; display: block;">
                        <div class="p-4">
                            <i class="fa fa-3x fa-hotel text-info m-0 mb-4"></i>
                            <h5>Niche Experiences</h5>
                            <p style="color: #0d6efd;">Indulge in curated adventures just for you. Whether it's adventure, wellness, culinary, or culture, TourGlow offers personalized trips</p>
                        </div>
                    </a>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                    <a href="travelGuide.php" class="service-item rounded pt-3 text-decoration-none"
                        data-toggle="modal" data-target="#exampleModal"
                        style="background-color: #ffffff !important; display: block;">
                        <div class="p-4">
                            <i class="fa fa-3x fa-hotel text-info m-0 mb-4"></i>
                            <h5>Local Guides</h5>
                            <p style="color: #0d6efd;">Experience Sri Lanka through the eyes of a local guide. Gain insights and personalized tours to enrich your journey through our wonders</p>
                        </div>
                    </a>
                </div>
    
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                    <a href="travelDiaries.php" class="service-item rounded pt-3 text-decoration-none"
                        data-toggle="modal" data-target="#exampleModal"
                        style="background-color: #ffffff !important; display: block;">
                        <div class="p-4">
                            <i class="fa fa-3x fa-hotel text-info m-0 mb-4"></i>
                            <h5>Travel Diaries</h5>
                            <p style="color: #0d6efd;">TourGlow's user profiles offer a space to chronicle your adventures, preserving memories and sharing experiences with Others</p>
                        </div>
                    </a>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                    <a href="currencyConvertor.php" class="service-item rounded pt-3 text-decoration-none"
                        data-toggle="modal" data-target="#exampleModal"
                        style="background-color: #ffffff !important; display: block;">
                        <div class="p-4">
                            
                            <i class="fa fa-3x fa-dollar-sign text-info m-0 mb-4"></i>
                            
                            <h5>Currency Converter</h5>
                            <p style="color: #0d6efd;">Get real-time currency exchange rates and convert your money hassle-free with our currency converter tool.</p>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                    <a href="userReviews.php" class="service-item rounded pt-3 text-decoration-none"
                        data-toggle="modal" data-target="#exampleModal"
                        style="background-color: #ffffff !important; display: block;">
                        <div class="p-4">
                            <i class="fa fa-3x fa-star text-info m-0 mb-4"></i>
                            <h5>User Reviews</h5>
                            <p style="color: #0d6efd;">Read authentic reviews from travelers worldwide and make informed decisions for your next adventure.</p>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                    <a href="budjetCalculator.php" class="service-item rounded pt-3 text-decoration-none"
                        data-toggle="modal" data-target="#exampleModal"
                        style="background-color: #ffffff !important; display: block;">
                        <div class="p-4">
                            <i class="fa fa-3x fa-calculator text-info m-0 mb-4"></i>
                            <h5>Budget Calculator</h5>
                            <p style="color: #0d6efd;">Plan your trip with confidence using our budget calculator. Easily estimate expenses and stay within your budget.</p>
                        </div>
                    </a>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                    <a href="/user-profile/profile.php" class="service-item rounded pt-3 text-decoration-none"
                        data-toggle="modal" data-target="#exampleModal"
                        style="background-color: #ffffff !important; display: block;">
                        <div class="p-4">
                            <i class="fa fa-3x fa-users text-info m-0 mb-4"></i>
                            <h5>User Profiles</h5>
                            <p style="color: #0d6efd;">Connect with fellow travelers, share experiences, and build your network within the travel community.</p>
                        </div>
                    </a>
                </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-info m-0 px-3">Packages</h6>
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="package-item">
                        ...
                        <div class="d-flex border-bottom">
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-map-marker-alt text-info m-0 me-2"></i>Thailand</small>
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt text-info m-0 me-2"></i>3 days</small>
                            <small class="flex-fill text-center py-2"><i class="fa fa-user text-info m-0 me-2"></i>2 Person</small>
                        </div>
                        <div class="text-center p-4">
                            <h3 class="mb-0">$149.00</h3>
                            <div class="mb-3">
                                <small class="fa fa-star text-info m-0"></small>
                                <small class="fa fa-star text-info m-0"></small>
                                <small class="fa fa-star text-info m-0"></small>
                                <small class="fa fa-star text-info m-0"></small>
                                <small class="fa fa-star text-info m-0"></small>
                            ...
                            <div class="d-flex justify-content-center mb-2">
                                <a href="#" class="btn btn-sm btn-info px-3 border-end" style="border-radius: 30px 0 0 30px;">Read More</a>
                                <a href="#" class="btn btn-sm btn-info px-3" style="border-radius: 0 30px 30px 0;">Book Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="package-item">
                        ...
                        <div class="d-flex border-bottom">
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-map-marker-alt text-info m-0 me-2"></i>Indonesia</small>
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt text-info m-0 me-2"></i>3 days</small>
                            <small class="flex-fill text-center py-2"><i class="fa fa-user text-info m-0 me-2"></i>2 Person</small>
                        </div>
                        <div class="text-center p-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="package-item">
                        ...
                        <div class="d-flex border-bottom">
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-map-marker-alt text-info m-0 me-2"></i>Malaysia</small>
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt text-info m-0 me-2"></i>3 days</small>
                            <small class="flex-fill text-center py-2"><i class="fa fa-user text-info m-0 me-2"></i>2 Person</small>
                        </div>
                        <div class="text-center p-4">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-info m-0 px-3">Travel Guide</h6>
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="img\pro-team-photos\1 (1).png" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="img/pro-team-photos/1 (6).png" alt="">
                        </div>
                        <div class="position-relative d-flex justify-content-center" style="margin-top: -19px;">
                            <a class="btn btn-square mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-square mx-1" href=""><i class="fab fa-twitter"></i></a>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="img/pro-team-photos/1 (2).png" alt="">
                        </div>
                        <div class="position-relative d-flex justify-content-center" style="margin-top: -19px;">
                            <a class="btn btn-square mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-square mx-1" href=""><i class="fab fa-twitter"></i></a>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="img/pro-team-photos/1 (5).png" alt="">
                        </div>
                        <div class="position-relative d-flex justify-content-center" style="margin-top: -19px;">
                            <a class="btn btn-square mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-square mx-1" href=""><i class="fab fa-twitter"></i></a>
